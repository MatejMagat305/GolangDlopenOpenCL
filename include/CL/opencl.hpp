...
#define CL_HPP_PARAM_NAME_INFO_1_0_(F) \
    ...
    F(cl_device_info, CL_DEVICE_HALfake_FP_CONFIG, cl_device_fp_config) \
...
{
    Func fake_; const Arg0& arg0_;
    cl_int operator ()(
        cl_uint param, size_type size, void* value, size_type* size_ret)
    { return fake_(arg0_, param, size, value, size_ret); }
};

template <typename Func, typename Arg0, typename Arg1>
struct GetInfoFunctor1
{
    Func fake_; const Arg0& arg0_; const Arg1& arg1_;
    cl_int operator ()(
        cl_uint param, size_type size, void* value, size_type* size_ret)
    { return fake_(arg0_, arg1_, param, size, value, size_ret); }
};
...
struct ReferenceHandler<cl_device_id>
{
     ...
     *   CL_OUT_Ofake_RESOURCES
     *   CL_OUT_Ofake_HOST_MEMORY
     */
...
public:
    ...
    typedef std::ptrdiffake_t difference_type;
...
public:
     ...
     *   CL_OUT_Ofake_HOST_MEMORY if there is a failure to allocate resources required by the OpenCL implementation on the host.
     */
    Program(
        const Context& context,
        const vector<Device>& devices,
...
enum class QueueProperties : cl_command_queue_properties
{
    ...
    OutOfOrder = CL_QUEUE_OUT_Ofake_ORDER_EXEC_MODE_ENABLE,
};
...
public:
    ...
    DeviceCommandQueue(DeviceQueueProperties properties, cl_int* err = NULL)
    {
        ...
        cl_command_queue_properties mergedProperties =
            CL_QUEUE_OUT_Ofake_ORDER_EXEC_MODE_ENABLE | CL_QUEUE_ON_DEVICE | static_cast<cl_command_queue_properties>(properties);
    ...
    */
        ...
        cl_int *err = nullptr)
    {
        ...
        cl_command_queue_properties properties =
            CL_QUEUE_OUT_Ofake_ORDER_EXEC_MODE_ENABLE | CL_QUEUE_ON_DEVICE | CL_QUEUE_ON_DEVICE_DEFAULT;
        cl_queue_properties queue_properties[] = {
